...
\fancyfoot[L]{\scriptsize  Graduation Project Report}
...
\begin{titlepage}
	...
	\begin{center}
		\begin{tabular}{c}
			...
			\textbf{\LARGE DEVELOPMENT OF AN ONLINE }    \\
			\textbf{\LARGE LIBRARY MANAGEMENT SYSTEM}
			\\
	...
	\begin{table}[h]
		\begin{tabular}{rll}
			\hspace{2.5 cm} & \textbf{\Large COUNCIL: 3CC Computer Science}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large TIME \& VENUE: 13:30 Oct 10, 2026 at CS1}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large Advisor 1: Dr. Truong Tuan Anh}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large Advisor 2: MSc. Vu Ngoc Tu}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large President: Dr. Le Thanh Van}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large Secretary: MSc. Vu Ngoc Tu}
			\\[0.2cm]
			\hspace{2.5 cm} & \textbf{\Large Member: MSc. Nguyen Phuong Duy}
			\\[0.2cm]
			% TKHĐ là THƯ KÝ HỘI ĐỒNG
			\hspace{4 cm} & \textbf{$\;$ $\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$ \Large ---o0o---}
			\\[0.2cm]
			\hspace{4 cm} & \textbf{\Large Student 1:} {\Large Nguyen Anh Khoa (2211614)}
			\\[0.2cm]
			\hspace{4 cm} & \textbf{\Large Student 2:}  {\Large Nguyen Tran Bao Khoa (2211610)}
			\\[0.2cm]
			\hspace{4 cm} & \textbf{\Large Student 3:}  {\Large Mai Nam Phuong (2252656)}
			\\[0.2cm]
		\end{tabular}
	\end{table}
	\vspace{0.5cm}
	\begin{center}
		{\Large HO CHI MINH CITY, OCTOBER 2026 }
	\end{center}
\end{titlepage}
%\thispagestyle{empty}
\newpage
...
\newpage
\input{Contents/Hethonglienquan}
\newpage
