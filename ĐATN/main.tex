...
\begin{titlepage}
	...
	\begin{table}[h]
		\begin{tabular}{rll}
			\hspace{4 cm} & \textbf{\Large COUNCIL: Council 2CC Graduation Project} {\Large }
			\\
			\\
			\hspace{4 cm} & \textbf{\Large Advisor 1: Dr. Truong Tuan Anh} {\Large }                                                                                                            %tien si                                                                                                 \\
			\\
			\hspace{4 cm} & \textbf{\Large Advisor 2: MSc. Vu Ngoc Tu} {\Large }                                                                                                                %thac si
			\\
			\\
			\hspace{4 cm} & \textbf{\Large Committee Secretary: MSc. Mai Duc Trung} {\Large}
			\\
			\\
